...
Rho_k_0 = 0;      %0dB
dn = 0.8;      %-1dB deep null
Rho_k = 10^(Rho_k_0/10);
index_m = [index_M(1) : 1 : index_M(2), index_M(3) : 1 :  index_M(4)];      %bordering the mainlobe region and the transition region
...
omiga_2 = 2900+180;
omiga_3 = 6101-180;
omiga_4 = 7600+311;     %omiga distinguish the sidelobe region with transition region and mainlobe region
