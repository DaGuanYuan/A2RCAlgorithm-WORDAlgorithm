...
Theta_0 = pi * -10 / 180;     %This angle could determine which position the pattern steers at
...
theta_M = (index_M-1) * 0.02 - 90;

Rho_k_0 = -0.1;      %0dB
dn = 1;      %-1dB deep null
Rho_k = 10^(Rho_k_0/10);
index_m = [index_M(1) : 1 : index_M(2), index_M(3) : 1 :  index_M(4)];
% index_m = [index_M(1) : 1 : index_M(2)];
...
% omiga_2 = 4400+270;
% omiga_3 = 5600-200;
% omiga_4 = 6500+270;     %omiga distinguish ¡°sidelobe region and transition region¡± with ¡°mainlobe region¡±

omiga_1 = 3500-190;
omiga_2 = 4400+236;
omiga_3 = 5600-233;
omiga_4 = 6500+264;     %omiga distinguish ¡°sidelobe region and transition region¡± with ¡°mainlobe region¡±
